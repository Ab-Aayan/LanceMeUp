...
import 'package:lancemeup/Login/auth/SignIn.dart';
import 'package:lancemeup/components/content_model.dart';
              ...
              itemBuilder: (_, i) {
                return Padding(
                  ...
                  child: Column(
                    children: [
                      Card(
                        color: const Color.fromARGB(78, 245, 239, 239),
                        shape: const RoundedRectangleBorder(
                          borderRadius: BorderRadius.only(
                              topLeft: Radius.circular(20),
                              topRight: Radius.circular(20)), //<-- SEE HERE
                        ),
